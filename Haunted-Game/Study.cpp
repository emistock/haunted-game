...
** Date: 8/15/17
** Description: A class Study that inherits from class Space. It represents a
room in the game.
*******************************************************************************/
...
*******************************************************************************/
Study::Study(Space* n, Space* s, Space* e, Space* w) : Space(n, s, e, w)
{
  spaceName = "Study";
  numRows = 7;
  numCols = 5;
...
*******************************************************************************/
void Study::changePos(Player* p, int x, int y, char input)
{
  gameBoard[x][y] = ' ';
...
*******************************************************************************/
void Study::showMap(bool flashlight)
{
...
*******************************************************************************/
void Study::setPlayerMarker(int x, int y)
{
  gameBoard[x][y] = 'O';
}
