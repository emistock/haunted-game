...
** Date: 8/13/17
** Description: A class called Bath that inherits from class Space. It represents
a room in a game.
*******************************************************************************/
...
*******************************************************************************/
Bath::Bath(Space* n, Space* s, Space* e, Space* w) : Space(n, s, e, w)
{
  spaceName = "Bathroom";
  numRows = 5;
  numCols = 5;
...
*******************************************************************************/
void Bath::changePos(Player* p, int x, int y, char input)
{
  gameBoard[x][y] = ' ';
...
void Bath::showHint()
{
  ...
  cout << "The bedroom is to the north." << endl;
}

/*******************************************************************************
Displays a map for the room if user has the item flashlight
*******************************************************************************/
void Bath::showMap(bool flashlight)
{
...
*******************************************************************************/
void Bath::setPlayerMarker(int x, int y)
{
  gameBoard[x][y] = 'O';
}
